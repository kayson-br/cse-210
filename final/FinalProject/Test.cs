...
public class Test : Work
{
    ...
    // CONSTRUCTOR
    public Test( string dueDateMonth, string dueDateDay, string title, string description, string questions, string points)
        : base("Test", dueDateMonth, dueDateDay, title, description)
    {
